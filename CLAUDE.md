...
- **Knowledge base (`docs/`)** — read at the start of a session to avoid context drift: `docs/STATUS.md` (where we are, next steps), `docs/DECISIONS.md` (why things are the way they are). Update them as you work — see `docs/README.md` for the protocol. Future features live in `ROADMAP.md`.
